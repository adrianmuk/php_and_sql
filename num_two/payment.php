...
if(isset($_POST["calculate"])){
  ...
  $firstName = $lastName = $positions = $basicPay = $duration =$overtime = "";
  ...
  $result = mysqli_query($con, "INSERT INTO payroll (firstName, lastName, positions, basicpay, duration, overtime, 
  overtimePay, grossPay,  HA, TA, MA, NSSF, PAYEE, netPay, totalAllowances) VALUES ('$firstName', '$lastName', '$positions', 
  '$basicPay', '$duration', '$overtime', '$overtimePay', '$grossPay', '$HA', '$TA', '$MA', '$NSSF', '$PAYEE', '$netPay', '$totalAllowances') ");
...
<body>
    ...
    <div id="forms">
        <form method="POST" action="">
            ...
            <label>For how long have you worked with us:</label><br>
            <input name="duration" type="number" id="input1" required><br>
            ...
            <input name="exit" type="reset" id="reset" value="EXIT">
        </form>
        <div id="box">
            <div id="results" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">
                ...
                <p>YEARS WORKED: <?php echo $duration?></p>
